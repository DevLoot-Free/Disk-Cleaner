...
🖥️ How to Use
Start the app via START.bat
Check your disk usage in the top bar
Click a quick-access folder (Downloads, Videos, etc.) or type a custom path
Browse the scan results — sorted by size, largest first
Select files or folders you want to delete (checkbox or click)
Click Delete — confirm the dialog — done
